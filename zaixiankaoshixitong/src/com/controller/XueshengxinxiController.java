...
//	分页查询
	...
	public String xueshengxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Xueshengxinxi xueshengxinxi, String xuehao, String xingming, String mima, String zhaopian, String banji, String jiguan, String xingbie, String shenfenzheng, String shouji, String beizhu){
