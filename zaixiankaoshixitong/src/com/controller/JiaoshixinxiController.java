...
//	分页查询
	...
	public String jiaoshixinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Jiaoshixinxi jiaoshixinxi, String gonghao, String xingming, String mima, String xingbie, String zhicheng, String shouji, String zhaopian, String kecheng, String beizhu){
