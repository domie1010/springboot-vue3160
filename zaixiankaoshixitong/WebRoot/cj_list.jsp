...
{
	connDbBean.hsgexecute("delete from cj where id="+request.getParameter("delid"));
}
%>
<body >
  <p>成绩列表：</p>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor="#CCFF99">操作</td>
  </tr>
  <%
ResultSet RS_result;
    String sql =  "select * from cj order by id desc";
...
%>
  <tr>
    ...
    <td><a href="cj_list.jsp?delid=<%=RS_result.getString("id") %>" onClick="return confirm('确定要删除？');">删除</a></td>
  </tr>
  	<%
  }
   %>
