	...
	<body>
			<form action="updateDanxuanti.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.shitibianhao.value='${danxuanti.shitibianhao}';</script>	<script language="javascript">document.form1.kecheng.value='${danxuanti.kecheng}';</script>	<script language="javascript">document.form1.timu.value='${danxuanti.timu}';</script>	<script language="javascript">document.form1.xuanxiangA.value='${danxuanti.xuanxiangA}';</script>	<script language="javascript">document.form1.xuanxiangB.value='${danxuanti.xuanxiangB}';</script>	<script language="javascript">document.form1.xuanxiangC.value='${danxuanti.xuanxiangC}';</script>	<script language="javascript">document.form1.xuanxiangD.value='${danxuanti.xuanxiangD}';</script>	<script language="javascript">document.form1.daan.value='${danxuanti.daan}';</script>	<script language="javascript">document.form1.jiexi.value='${danxuanti.jiexi}';</script>	
					 </table>
			</form>
   </body>
</html>
