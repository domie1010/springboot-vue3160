...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateTiankongti.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改填空题<input type="hidden" name="id" value="${tiankongti.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.shitibianhao.value='${tiankongti.shitibianhao}';</script>	<script language="javascript">document.form1.kecheng.value='${tiankongti.kecheng}';</script>	<script language="javascript">document.form1.timu.value='${tiankongti.timu}';</script>	<script language="javascript">document.form1.daan.value='${tiankongti.daan}';</script>	<script language="javascript">document.form1.jiexi.value='${tiankongti.jiexi}';</script>	
					 </table>
			</form>
   </body>
</html>
