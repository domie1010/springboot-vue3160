...
<html>
 <head>
  ...
  String nduoxuantifenzhi="";
   ...
   %>
            <p>试卷编号：<%=bianhao%></p> 时间：1小时，现在开始计时！剩余<SPAN id=tiao></SPAN>秒 <SCRIPT language=javascript>
...
//nanyichengdu=map.get("nanyichengdu");
 addtime=RS_result.getString("addtime");
              ...
              <tr>
                <td width="8%" height="33">试题<%=i%>：</td>
                <td>题目：<%=timu%>
                    <input name="dxtshitida<%=i%>" type="hidden" id="dxtshitida<%=i%>" value="<%=daan%>"></td>
              </tr>
              <tr>
                <td rowspan="4">选项</td>
                <td width="92%"><input type="checkbox" name="dxtxxa<%=i%>" value="A" id="dxtxxa<%=i%>">                
                  选项A：<%=xuanxiangA%></td></tr>
              <tr>
                <td><input type="checkbox" name="dxtxxa<%=i%>" value="B" id="dxtxxa<%=i%>">
选项B：<%=xuanxiangB%></td>
              </tr>
              <tr>
                <td><input type="checkbox" name="dxtxxa<%=i%>" value="C" id="dxtxxa<%=i%>">
选项C：<%=xuanxiangC%></td>
              </tr>
              <tr>
                <td><input type="checkbox" name="dxtxxa<%=i%>" value="D" id="dxtxxa<%=i%>">
选项D：<%=xuanxiangD%></td>
              </tr>
              <%
											  }
...
//nanyichengdu=map.get("nanyichengdu");
 addtime=RS_result.getString("addtime");
              ...
              <tr>
                <td width="8%" height="33">试题<%=i%>：</td>
                <td>题目：<%=timu%>
                    <input name="tktshitida<%=i%>" type="hidden" id="tktshitida<%=i%>" value="<%=daan%>"></td>
              </tr>
              <tr>
                <td>答案</td>
