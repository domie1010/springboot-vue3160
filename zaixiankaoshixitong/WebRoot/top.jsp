...
<body topmargin="0">
 <table width="100%" height="84" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td background="images/hsg3.gif"  class="top"><div style="font-family:宋体; color:#FF6600; WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 24pt; margin-top:5pt">
      <div align="left" >在线考试系统</div>
    </div></td>
